#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 on Tue Mar 22 14:36:30 2011
...
class AddinMakerWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.properties_rows_holder_staticbox = wx.StaticBox(self.notebook_1_pane_1, -1, _("Project Properties:"))
        self.title_panel = wx.Panel(self, -1)
        self.title_label = wx.StaticText(self.title_panel, -1, _("Python Add-In Wizard"), style=wx.ALIGN_RIGHT)
        self.static_line_3 = wx.StaticLine(self, -1)
        self.logo_bitmap = wx.StaticBitmap(self.logo_panel, -1, wx.Bitmap("images\\AddInDesktop64.png", wx.BITMAP_TYPE_ANY))
        self.folder_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Working Folder:"), style=wx.ALIGN_RIGHT)
        self.folder_button = wx.Button(self.notebook_1_pane_1, -1, _("Select Folder..."))
        self.product_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Select Product:"), style=wx.ALIGN_RIGHT)
        ...
        self.project_name_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Name*:"), style=wx.ALIGN_RIGHT)
        self.project_name = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.project_version_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Version*:"), style=wx.ALIGN_RIGHT)
        self.project_version = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.project_company_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Company:"), style=wx.ALIGN_RIGHT)
        self.project_company = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.project_description_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Description:"), style=wx.ALIGN_RIGHT)
        self.project_description = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.project_author_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Author:"), style=wx.ALIGN_RIGHT)
        self.project_author = wx.TextCtrl(self.notebook_1_pane_1, -1, "")
        self.static_line_2 = wx.StaticLine(self.notebook_1_pane_1, -1)
        self.project_image_label = wx.StaticText(self.notebook_1_pane_1, -1, _("Image:"), style=wx.ALIGN_RIGHT)
        self.select_project_image = wx.Button(self.notebook_1_pane_1, -1, _("Select Image..."))
        ...
        self.open_folder = wx.Button(self, -1, _("Open Folder"))
        self.save_button = wx.Button(self, -1, _("Save"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("ArcGIS Python Add-In Wizard"))
        _icon = wx.EmptyIcon()
    ...
    def __do_layout(self):
        ...
        self.tabs_notebook.AddPage(self.notebook_1_pane_1, _("Project Settings"))
        self.tabs_notebook.AddPage(self.notebook_1_pane_2, _("Add-In Contents"))
        ...
        sizer_2.Add(self.open_folder, 0, 0, 0)
        sizer_2.Add(self.save_button, 0, 0, 0)
